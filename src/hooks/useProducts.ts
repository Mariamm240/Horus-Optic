  ...
  return [
    {
      ...
      price: 149900,
      imageUrl: '/Media/Lentes de contacto/24.png',
    ...
    },
    {
      ...
      price: 129900,
      imageUrl: '/Media/Lentes de contacto/25.png',
      category: 'lentes-contacto',
      brand: 'Biofinity',
      inStock: true,
      stockQuantity: 30,
    ...
    },
    {
      ...
      price: 169900,
      imageUrl: '/Media/Lentes de contacto/26.png',
      category: 'lentes-contacto',
      brand: 'Air Optix',
      inStock: true,
      stockQuantity: 25,
    ...
    },
    {
      ...
      price: 299900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/5.png',
      category: 'gafas-sol',
      brand: 'Ray-Ban',
      inStock: true,
      stockQuantity: 15,
    ...
    },
    {
      ...
      price: 259900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/6.png',
      category: 'gafas-sol',
      brand: 'Oakley',
      inStock: true,
      stockQuantity: 20,
    ...
    },
    {
      ...
      price: 899900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/7.png',
    ...
    },
    {
      ...
      description: 'Diseño sofisticado para profesionales',
      price: 459900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/8.png',
      category: 'monturas',
      brand: 'Horus Optic',
      inStock: true,
      stockQuantity: 12,
      rating: 4.9,
      reviewCount: 89,
      features: ['Marco titanio', 'Ultra liviano', 'Diseño ergonómico'],
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      price: 329900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/9.png',
      category: 'gafas-sol',
      brand: 'Horus Sport',
      inStock: true,
      stockQuantity: 18,
      rating: 4.7,
      reviewCount: 156,
      features: ['Resistente al agua', 'Lentes polarizadas', 'Marco flexible'],
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: '9',
      name: 'Lentes de Contacto Premium Color',
      description: 'Cambia tu look con colores naturales',
      price: 189900,
      imageUrl: '/Media/Lentes de contacto/27.png',
      category: 'lentes-contacto',
      brand: 'ColorVision',
      inStock: true,
      stockQuantity: 22,
      rating: 4.8,
      reviewCount: 94,
      features: ['Colores naturales', 'Uso mensual', 'Hidratación premium'],
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      id: '10',
      name: 'Monturas Clásicas Vintage',
      description: 'Estilo retro con tecnología moderna',
      price: 379900,
      imageUrl: '/Media/CATALOGO WEB 600 x400/10.png',
      category: 'monturas',
      ...
      rating: 4.6,
      reviewCount: 73,
      features: ['Diseño vintage', 'Marco acetato', 'Bisagras premium'],
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    }
  ];
